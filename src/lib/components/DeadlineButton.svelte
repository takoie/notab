...
<button
  bind:this={trigger}
  type="button"
  class="flex h-8 items-center gap-1.5 rounded-lg px-1.5 transition-colors hover:bg-surface-sunken"
...
<Popover anchor={trigger} bind:open placement="bottom-start" label="Sett frist" class="w-72 p-2.5">
  <div class="flex flex-wrap items-center gap-1.5">
    ...
    >
      ...
      <input
        ...
        onchange={(e) => {
          value = fromDateInput(e.currentTarget.value);
          open = false;
        }}
      />
    </label>
